...
const DesktopItems = ({ isStartMenuOpen, setShowModal, setGame, setCodeIde }) => {
  return (
    <div className={isStartMenuOpen ? "hidden" : "block w-full"}>
      <div className="flex flex-col items-start justify-start w-full p-8 gap-6">
        ...
        >
          <SiVisualstudiocode className="text-blue-700 text-6xl" />
          <p className="text-white text-center">VS Code</p>
        </div>
